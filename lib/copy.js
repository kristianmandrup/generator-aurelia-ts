...
module.exports = function(gen) {
  var base = {
    ...
    createFn: function(fn, baseFrom, baseTo) {
      ...
      return function(fromPath, toPath, opts) {
        opts = opts || {};
        this[fn](path.join(baseFrom, fromPath), path.join(baseTo, toPath), opts)
      }
    }
  };
  ...
  base.rootTpl = base.createFn('template', 'root', '.');
  base.buildFile = base.createFn('file', 'tasks', 'build/tasks');
  base.buildTpl = base.createFn('template', 'tasks', 'build/tasks');
  return base;
};
